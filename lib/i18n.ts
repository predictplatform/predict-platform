...
export const translations = {
  ...
  en: {
    ...
    footer: {
      ...
      contactQuestion: 'Have a suggestion? Found a bug? Want to reach us?',
      copyright:       '⚽ Dawri Tawaquat — 100% free | No financial betting',
    ...
    // ── Home page ────────────────────────────────────────────────────────
    home: {
      heroTitle:        '⚽ Dawri Tawaquat',
      heroSubtitle:     'Predict matches, earn points, compete with friends',
      ...
      pts5Label:  '100% exact result',
      pts4Label:  'Correct direction & goal diff',
      pts3Label:  'Correct direction only',
      pts0Label:  'Completely wrong',
    },
    ...
    predCard: {
      ...
      savingBtn:       'Saving...',
      recordedMsg:     'Prediction recorded ✓ — cannot be changed now',
      shareTwitter:    'Share',
